...
uses
  ...
  procedure ShowLoad(sMessage: string = 'Processando. Por favor, aguarde...'; bLoad: Boolean = True);
  procedure CloseLoad();
...
uses
 ...
 var
  ...
  procedure ShowLoad(sMessage: string = 'Processando. Por favor, aguarde...'; bLoad: Boolean = True);
  begin
    if not Assigned(FormDialogAwait) then
      FormDialogAwait         := TFormDialogAwait.Create(Application);
